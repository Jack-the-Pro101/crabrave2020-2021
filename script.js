...
{ 
    ...
    if (currentMonth == 10 && currentDayOfMonth == 5 && currentHour == 21 && currentMinute == 37 && currentSecond == 44 && currentMilliSecond > 0 && currentMilliSecond < 50)
    {
      masterTimer();
    }

    if (currentMonth == 10 && currentDayOfMonth == 5 && currentHour == 21 && currentMinute == 38 && currentSecond == 44 && currentMilliSecond > 900 && currentMilliSecond < 1000)
    {
      initVideo();
    }
